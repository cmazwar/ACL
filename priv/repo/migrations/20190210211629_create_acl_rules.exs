defmodule Acl.Repo.Migrations.CreateAclRules do
  ...
  def change do
    create table(:acl_rules, primary_key: false) do
      add :role, references(:acl_roles, column: :role, type: :string, on_delete: :delete_all,primary_key: true)
      add :res_id, references(:acl_res, column: :id, type: :id, on_delete: :delete_all, primary_key: true)
